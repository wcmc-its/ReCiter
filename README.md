...
## Key ReCiter methods and their functions, in order of program flow, as of 1-15-2016.
Note that this list is not exhaustive; it is meant to be an overview of the functioning of the algorithm.
